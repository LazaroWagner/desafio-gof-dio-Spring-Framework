...
* The original package name 'one.desafio.gof.desafio-lab-padroes-projeto-gof-spring' is invalid and this project uses 'one.desafio.gof.desafio_lab_padroes_projeto_gof_spring' instead.
